...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<ItemInfoResponseDto> saveItem(@RequestBody ItemSaveRequestDto itemSaveRequestDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(itemService.saveItem(itemSaveRequestDto));
    }
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<ItemInfoResponseDto> updateItem(@PathVariable Long itemId,
                                                          @Valid @RequestBody ItemSaveRequestDto itemSaveRequestDto) {
